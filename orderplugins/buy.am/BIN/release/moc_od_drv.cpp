...
void OD_Drv::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (OD_Drv::*)(const QMap<QString,QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OD_Drv::counted)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OD_Drv::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OD_Drv::dishRepaint)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OD_Drv::staticMetaObject = { {
    QMetaObject::SuperData::link<OD_Base::staticMetaObject>(),
    qt_meta_stringdata_OD_Drv.data,
    qt_meta_data_OD_Drv,
    qt_static_metacall,
    nullptr,
    nullptr
