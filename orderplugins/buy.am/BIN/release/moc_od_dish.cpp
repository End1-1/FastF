...
void OD_Dish::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OD_Dish *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OD_Dish::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OD_Dish::update)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OD_Dish::*)(int , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OD_Dish::removed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (OD_Dish::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OD_Dish::message)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OD_Dish::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_OD_Dish.data,
    qt_meta_data_OD_Dish,
    qt_static_metacall,
    nullptr,
    nullptr
} };
