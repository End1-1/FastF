...
QT_INIT_METAOBJECT const QMetaObject FF_HallDrv::staticMetaObject = { {
    QMetaObject::SuperData::link<DbDriver::staticMetaObject>(),
    qt_meta_stringdata_FF_HallDrv.data,
    qt_meta_data_FF_HallDrv,
    qt_static_metacall,
    nullptr,
    nullptr
} };
