...
QT_INIT_METAOBJECT const QMetaObject RemindThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_RemindThread.data,
    qt_meta_data_RemindThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void FF_OrderDrv::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FF_OrderDrv *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (FF_OrderDrv::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject FF_OrderDrv::staticMetaObject = { {
    QMetaObject::SuperData::link<QSqlDrv::staticMetaObject>(),
    qt_meta_stringdata_FF_OrderDrv.data,
    qt_meta_data_FF_OrderDrv,
    qt_static_metacall,
    nullptr,
    nullptr
} };
